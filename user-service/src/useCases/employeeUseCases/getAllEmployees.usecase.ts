...
class AllEmployees {
  constructor() { }
  async AllEmployees(employee: string) {
    try {
      await messageBroker.sendMessage("read_employee", employee);
      // send message to the queue
      await messageBroker.listenForResponse("readed_employee");
...
export default new AllEmployees()